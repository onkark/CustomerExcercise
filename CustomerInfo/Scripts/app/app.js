...
var appRoot = angular.module('main', ['ngRoute', 'ngGrid', 'ngResource', 'angularStart.services', 'angularStart.directives', 'ui.bootstrap', 'dialogs']);     //Define the main module
...
appRoot
    .config(['$routeProvider', function ($routeProvider) {
        ...
        $routeProvider
            ...
            .when('/customer', { templateUrl: '/home/customer', controller: 'CustomerController' })
